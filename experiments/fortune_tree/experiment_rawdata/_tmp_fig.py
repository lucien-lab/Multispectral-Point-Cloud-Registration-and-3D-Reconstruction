...
ELEV, AZIM = 20, -60
S_VIEW, S_MERGED = float(os.environ.get('S_VIEW',3.4)), float(os.environ.get('S_MERGED',4.0))
MERGED_VOXEL = 0.004
...
M["未配准"] = M_UNREG[voxel_idx(M_UNREG, MERGED_VOXEL)]
MVIS = {k: M_VIS_FULL[voxel_idx(v, MERGED_VOXEL)] for k, v in M_RAW.items()}
MVIS["未配准"] = M_VIS_FULL[voxel_idx(M_UNREG, MERGED_VOXEL)]
